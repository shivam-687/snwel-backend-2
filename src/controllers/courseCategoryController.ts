...
import { getAllCourseCategories, createCourseCategory, getCourseCategoryById, updateCourseCategoryById, deleteCourseCategoryById, attachParentCategory } from '@/service/courseCategoryService';
