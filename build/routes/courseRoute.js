...
router.post('/', courseController_1.createCourseController);
router.get('/byId/:courseId', courseController_1.getCourseByIdController);
router.put('/:courseId', courseController_1.updateCourseController);
router.delete('/:courseId', courseController_1.deleteCourseController);
